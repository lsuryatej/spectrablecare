        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10 md:gap-8">
          ...
          <div className="md:col-span-1">
            <Link href="/" className="inline-block mb-4">
              <span className="font-serif text-xl text-ink-inverse leading-none">
                Spectr<span className="text-cta">A</span>ble
              </span>
            </Link>
            <p className="text-small text-ink-muted leading-relaxed">
              Daily care support for children with autism. Connecting caregivers,
          ...
          {/* Quick links */}
          <div>
            <p className="text-label font-semibold uppercase tracking-widest text-ink-muted mb-4">
              Platform
            </p>
          ...
          <div>
            ...
            <div className="flex items-center gap-3 mt-4">
              <a
                ...
                aria-label="LinkedIn"
                className="w-8 h-8 flex items-center justify-center rounded-full border border-white/10 text-ink-inverse/60 hover:text-ink-inverse hover:border-white/30 transition-all duration-200"
              >
